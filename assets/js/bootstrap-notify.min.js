/* ======================== bootstrap-notify.min.js ===================== */ ! function(t) {
    ...
    String.format = function() {
        ...
        init: function() {
            var t = this;
            this.BigdealNotify(), this.settings.content.icon && this.setIcon(), "#" != this.settings.content.url && this.styleURL(), this.styleDismiss(), this.placement(), this.bind(), this.notify = {
                $ele: this.$ele,
                update: function(s, e) {
                    var i = {};
